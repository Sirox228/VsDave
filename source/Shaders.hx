...
class DitherShader extends FlxVersionShader
{
    ...
    @:glFragmentSource('
        ...
        {
            if (x == 0) {
        	return { 0, 32, 8, 40, 2, 34, 10, 42}; /* 8x8 Bayer ordered dithering */
            }
            if (x == 1) {
            	return {48, 16, 56, 24, 50, 18, 58, 26}; /* pattern. Each input pixel */
            }
            if (x == 2) {
            	return {12, 44, 4, 36, 14, 46, 6, 38}; /* is scaled to the 0..63 range */
            }
            if (x == 3) {
            	return {60, 28, 52, 20, 62, 30, 54, 22}; /* before looking in this table */
            }
            if (x == 4) {
            	return { 3, 35, 11, 43, 1, 33, 9, 41}; /* to determine the action. */
            }
            if (x == 5) {
            	return {51, 19, 59, 27, 49, 17, 57, 25};
            }
            if (x == 6) {
            	return {15, 47, 7, 39, 13, 45, 5, 37};
            }
            if (x == 7) {
            	return {63, 31, 55, 23, 61, 29, 53, 21};
            }
